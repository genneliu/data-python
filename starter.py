...
# If the variable is a 90 or above, console-log an 'A', b
# etween 80 and 89, console-log a 'B', between 70 and 79, 'C', 
...
# to the end of the array (similar to push() in JavaScript), then add a name to the end of the `friends` array.
friends.append("Genne")
print(friends)
